...
class EarthGenre:
    ...
    def test(self):
        ...
        print(f"Вы — {self.hero_name}. Вас призвали на войну с инопланетянами.")
